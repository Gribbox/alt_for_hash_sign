This is a script I wrote that changes the input of the right Alt key to hash sign # in both Russian and English keyboard layouts. I use "#" frequently in my Obsidian vault, and by default, in the English layout, it's a combination of two keys, while in the Russian layout, this symbol doesn't exist. I couldn't find any ready-made working solutions, so I created this script.
...
Remap any key to input hash sign # quickly
